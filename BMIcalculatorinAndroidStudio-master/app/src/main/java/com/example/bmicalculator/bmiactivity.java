...
public class bmiactivity extends AppCompatActivity {
  ...
  //      getSupportActionBar().setBackgroundDrawable(colorDrawable);
        ...
        getSupportActionBar().setTitle("Resultât");
    ...
    //    mweightdisplay=findViewById(R.id.weightdisplay);
     ...
     //   mheightdisplay=findViewById(R.id.heightdisplay);
        ...
        height=intent.getStringExtra("taille");
        weight=intent.getStringExtra("masse");
        ...
        if(intbmi<16)
        {
            mbmicategory.setText("Minceur sévère");
        ...
        {
            mbmicategory.setText("Minceur modéré");
        ...
        {
            mbmicategory.setText("Minceur Légère");
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.warning);
       //   mimageview.setBackground(colorDrawable2);
        }
        ...
        {
            mbmicategory.setText("Corpulence normale");
        ...
        {
            mbmicategory.setText("Obésité sévère");
            mbackground.setBackgroundColor(R.color.halfwarn);
            mimageview.setImageResource(R.drawable.warning);
          //  mimageview.setBackground(colorDrawable2);
        }
        ...
        {
            mbmicategory.setText("Obésité morbide");
       ...
       //mheightdisplay.setText("Your Height is "+intent.getStringExtra("height"));
        ...
        mgender.setText(intent.getStringExtra("genre"));
